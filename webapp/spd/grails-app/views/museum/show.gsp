            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="museum.oldSpdId.label" default="Old Spd Id" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="region" action="show" id="${museumInstance?.region?.id}">${museumInstance?.region?.encodeAsHTML()}</g:link></td>
