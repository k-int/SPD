            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="school.oldSpdId.label" default="Old Spd Id" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="region" action="show" id="${schoolInstance?.region?.id}">${schoolInstance?.region?.encodeAsHTML()}</g:link></td>
